...
class Menu:
    def __init__(self, window):
        self.window = window
        self.surf = pygame.image.load('C:/Users/55219/PycharmProjects/Jogo/asset/MenuBg.png').convert_alpha()
    ...
    def run(self):
        ...
        while True:
            ...
            self.menu_text(10,"Ana Clara Martins Damasceno | RU: 4771859", C_WHITE, (125,10))
