...
class Level:
    def __init__(self, window, name, game_mode, timeout=20000):
        self.blit = None
        self.window = window
        self.name = name
    ...
    def run(self):
        pygame.mixer_music.load(f'C:/Users/55219/PycharmProjects/Jogo/asset/{self.name}.mp3')
        ...
        while True:
            ...
            for event in pygame.event.get():  # Move the event handling loop here
